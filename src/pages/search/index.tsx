                        ...
                        <div className='w-full flex'>
                            ...
                            <div className='ml-4 w-full md:w-3/4'>
                                ...
                                <div className='my-3 mx-4'>
                                    ...
                                    <button onClick={() => handleFilter('arrivalDateStart')} className='px-5 py-1 text-sm text-white bg-violet-700 rounded-lg'>
                                        <span className='font-medium text-base text-white'>Kedatangan Paling Awal</span>
                                    </button>
                                    <button onClick={() => handleFilter('arrivalDateEnd')} className='px-5 py-1 text-sm text-white bg-violet-700 rounded-lg'>
