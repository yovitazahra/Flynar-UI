              ...
              <div className='w-1/4 filter-box hidden md:flex'>
                <div className='h-fit w-full shadow-lg p-5 rounded-lg' id='accordionPanelsStayOpenExample'>
                  ...
                  <div className='my-3 mx-4'>
                    <button onClick={() => { void handleFilter('price') }} className='px-5 py-1 text-sm text-white bg-blue-500'>
                      <span className='font-medium text-base text-white'>Harga Termurah</span>
                    </button>
                    <button onClick={() => { void handleFilter('duration') }} className='px-5 py-1 text-sm text-white bg-green-500'>
                      <span className='font-medium text-base text-white'>Durasi Tercepat</span>
                    </button>
                    <button onClick={() => { void handleFilter('departureDateStart') }} className='px-5 py-1 text-sm text-white bg-yellow-400'>
                      <span className='font-medium text-base text-white'>Keberangkatan Paling Awal</span>
                    </button>
                    <button onClick={() => { void handleFilter('departureDateEnd') }} className='px-5 py-1 text-sm text-white bg-yellow-400'>
                      <span className='font-medium text-base text-white'>Keberangkatan Paling Akhir</span>
                    </button>
                    <button onClick={() => { void handleFilter('arrivalDateStart') }} className='px-5 py-1 text-sm text-white bg-green-700'>
                      <span className='font-medium text-base text-white'>Kedatangan Paling Awal</span>
                    </button>
                    <button onClick={() => { void handleFilter('arrivalDateEnd') }} className='px-5 py-1 text-sm text-white bg-blue-700'>
