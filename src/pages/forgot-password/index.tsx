...
const ForgotPassword = (): ReactElement => {
  return (
    <>
      ...
      <div id='ForgotPassword-page' className='flex h-screen overflow-hidden'>
            ...
            <form action=''>
              ...
              <div className='flex flex-col gap-y-3 text-sm'>
                <div className='flex flex-col gap-y-2'>
                  ...
                  <input type='text' autoComplete='off' autoCorrect='false' placeholder='Contoh: johndoe@gmail.com' id='email' className='border rounded-2xl px-4 py-3'/>
                </div>
              </div>
              <button type='submit' className = 'w-full bg-purple-600 text-white rounded-2xl px-6 py-3 text-sm mt-8' > <a href='reset-password'>Kirim Token</a>
              </button>
            </form>
          </div>
        </div>
